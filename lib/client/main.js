...
require([
  ...
  function updateIW() {
    $("#psyop_normal #value").text(g_gameState.currentPsyOpAttackCost);
    $("#psyop_reinforced #value").text(g_gameState.currentPsyOpDefendCost);
    $("#ew_normal #value").text(g_gameState.currentEWAttackCost);
    $("#ew_reinforced #value").text(g_gameState.currentEWDefendCost);
