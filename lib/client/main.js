        ...
        if (result.attacker === getPlayerColour()) {
          if (result.strength === 'feint') {
            ...
            if (result.type === 'psyop') {
              print("Your psionic attack was successful. Your opponent lost a piece.");
            ...
            if (result.type === 'psyop') {
              print("Your psionic attack was unsuccessful.");
              var $flash = $("#flashes #psyop");
          ...
          if (result.strength === 'feint') {
            ...
            if (result.type === 'psyop') {
              print(prefix+"You have lost a piece to psionic operations.");
              var $flash = $("#flashes #psyop");
