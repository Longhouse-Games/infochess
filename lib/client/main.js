...
require([
  ...
  function createArmySelector() {
    ...
    */
    ...
    $('#army_selector #ew_points').change(function() {
      var psyop_points = 10-this.value;
      var ew_points = this.value;
  ...
  var tabs = {
    notes: { content: $notes, selector: $("#notes_selector") },
    chat: { content: $chat, selector: $("#chat_selector"), indicator: $chat_message_indicator },
    log: { content: $log, selector: $("#log_selector") },
  };
