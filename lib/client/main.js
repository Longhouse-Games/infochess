...
require([
  ...
  function updateActions() {
    ...
    if (g_gameState.getCurrentRole() !== g_role ||
      ...
      if (g_gameState.currentEWAttackCost != 1) {
        g_actions_enabled.ew_feint = true;
      }
      if (g_gameState.currentPsyOpAttackCost != 1) {
  ...
  function updateIW() {
    ...
    $("#psyop_reinforced #value").text(pluralize(g_gameState.currentPsyOpAttackCost + 1));
    $("#psyop_feint #value").text(pluralize(g_gameState.feintCost));
    $("#ew_normal #value").text(pluralize(g_gameState.currentEWAttackCost));
    $("#ew_reinforced #value").text(pluralize(g_gameState.currentEWAttackCost + 1));
