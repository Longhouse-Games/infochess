...
function InfoChess() {
   ...
   * strength of the initial attack will be indicated by `iw_attack.strength` and
   * will be one of `normal`, `reinforced`, or `feint`.
   *
...
InfoChess.prototype.iw_attack = function(role, options) {
  ...
  this.currentTurn.iw_attack = this.current_iw_attack;
