...
PlayingBoard.prototype.getCastlingMoves = function(piece) {
  ...
  if (piece.type === 'king' || piece.type === 'rook') {
    ...
    if (king && king.type === 'king' && !this.castlingState[piece.colour].king) {
      ...
      var i = 0;
      if (left_corner && left_corner.type === 'rook' && !this.castlingState[piece.colour].queenside_rook) {
      ...
      if (right_corner && right_corner.type === 'rook' && !this.castlingState[piece.colour].kingside_rook) {
